...
using ProbablyAskew.UI;
using UitkForKsp2.API;
using UnityEngine;
using UnityEngine.UIElements;

namespace ProbablyAskew;

[BepInPlugin(MyPluginInfo.PLUGIN_GUID, MyPluginInfo.PLUGIN_NAME, MyPluginInfo.PLUGIN_VERSION)]
[BepInDependency(SpaceWarpPlugin.ModGuid, SpaceWarpPlugin.ModVer)]
public class ProbablyAskewPlugin : BaseSpaceWarpPlugin
{
    ...
    [PublicAPI] public static ProbablyAskewPlugin Instance { get; set; }

    // AppBar button IDs
    internal const string ToolbarFlightButtonID = "BTN-ProbablyAskewFlight";
    internal const string ToolbarOabButtonID = "BTN-ProbablyAskewOAB";
    internal const string ToolbarKscButtonID = "BTN-ProbablyAskewKSC";
    ...
    public override void OnInitialized()
    {
        ...
        var windowOptions = new WindowOptions
        {
            ...
            WindowId = "ProbablyAskew_MyFirstWindow",
    ...
    private static void LoadAssemblies()
    {
        ...
        var unityAssembly = Assembly.LoadFrom(Path.Combine(currentFolder, "ProbablyAskew.Unity.dll"));
